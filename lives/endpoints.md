...
Lists viewers watching the live stream (paginated, active viewers first).

- **Auth:** Optional
- **Query Parameters:**
  - `page` (number, default: 1): Page number.
  - `limit` (number, default: 20, max: 100): Items per page.
  - `activeOnly` (boolean, default: true): If `true`, returns only currently active viewers (`leftAt: null`). If `false`, includes historical sessions.
- **Response (200 OK):**
```json
{
  "data": [
